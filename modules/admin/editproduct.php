...
<?php 
    ...
    if(isset($_POST['btn_save'])){
        ...
        if(empty($error)){
            $sql = "UPDATE `product` SET `nameProduct`='$nameProduct',`typeProduct`='$typeProduct',`popularity`='$popularity',`infoProduct`='$infoProduct', `parameters`='$parameters',`price`='$price',`imgProduct`='$nameImg',`status`='$status' where id = $id";
            ...
            $_SESSION['editproduct'] = "<div class='text-danger mb-3 text-center'><b>Chỉnh sửa sản phẩm không thành công!</b></div>";
        }
    }
?>
<br><br><br>
...
<h2 class="text-center p-2 mt-4 mb-4" style="color: rgb(47, 47, 162);;">CHỈNH SỬA SẢN PHẨM</h2>
    <?php 
        if(isset($_SESSION['editproduct'])){
            echo $_SESSION['editproduct'];
    ...
    <form  method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-9">
                    <span><input style='padding: 16px 4px; font-size: 14px' type="radio" name="popularity" value="Có" <?php if(isset($popularity) && $popularity == 'Có'){echo "checked='checked'";}?>>Có</span>
                    <span class="mx-3"><input type="radio" name="popularity" value="Không" <?php if(isset($popularity) && $popularity == 'Không'){echo "checked='checked'";}?>>Không</span>
                    <?php 
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-9">
                    <span><input style='padding: 16px 4px; font-size: 14px' type="radio" name="status" value="Còn hàng" <?php if(isset($status) && $status == 'Còn hàng'){echo "checked='checked'";}?>>Còn hàng</span>
                    <span class="mx-3"><input type="radio" name="status" value="Hết hàng" <?php if(isset($status) && $status == 'Hết hàng'){echo "checked='checked'";}?>>Hết hàng</span>
                    <?php 
