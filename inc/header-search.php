          ...
          <div class="header__box">
            ...
            <ul class="header__box-list">
              ...
              <li class="header__box-item header__box-item-no-cart">
                <a href="http://localhost/LHSport/?mod=cart&act=show" class="header__box-item-link">
              ...
              <li class="header__box-item header__box-item-no-cart">
                <a href="http://localhost/LHSport/?mod=cart&act=order" class="header__box-item-link">
              ...
              <li class="header__box-item header__box-item--account">
                ...
                <div class="header__box-item-user">
                  <a href="http://localhost/LHSport/?mod=users&act=signup" class="header__box-item-user-account">
                  ...
                  <a href="http://localhost/LHSport/?mod=users&act=login" class="header__box-item-user-account">
              ...
              <li>
                <a href="?mod=users&act=profile">
                  ...
                  if (isset($_SESSION['user']['username']) && $_SESSION['user']['username'] != 'admin') {
                    echo "<span class='user_login'>{$_SESSION['user']['username']}</span>" . "<a href='?mod=users&act=logout' class='user_logout'>(Thoát)</a>";
                  }
                  ?>
                </a>
              </li>
          ...
          <div class="grid">
            <ul class="header__nav-list">
              <li class="header__nav-item">
                <a href="http://localhost/LHSport/?mod=home&act=main" class="header__nav-item--link">
                  Trang chủ
                </a>
              </li>

              <li class="header__nav-item header__nav-item--product">
                <a href="http://localhost/LHSport/?mod=product&act=main" class="header__nav-item--link">
                  Sản phẩm
                </a>
              </li>

              <li class="header__nav-item">
                <a href="http://localhost/LHSport/?mod=pages&act=introduce" class="header__nav-item--link">
                  Giới thiệu
                </a>
              </li>

              <li class="header__nav-item">
                <a href="http://localhost/LHSport/?mod=pages&act=contact" class="header__nav-item--link">
                  Liên hệ
                </a>
              </li>

              <li class="header__nav-item header__nav-item--search">
                <form class="header__nav-item-form" action="" method="GET">
